...
<html>
<head>
	<title>ERP Demo - Update Customer</title>
</head>
...
<body>
<h2><spring:message code="module.customer.modify.title"/></h2>
<form:form method="post" action="../update.html" commandName="customer">
	...
	<tr>
		<td colspan="2">
			<input type="submit" value="<spring:message code="module.customer.button.modify"/>"/>
		</td>
	</tr>
	</table>
</form:form>
