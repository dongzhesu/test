...
<body>
<h2><spring:message code="module.order.modify.title"/></h2>
<form:form method="post" action="../update.html" commandName="order">
	...
	<tr>
		<td colspan="2">
			<input type="submit" value="<spring:message code="module.order.button.modify"/>"/>
		</td>
	</tr>
	</table>
</form:form>
