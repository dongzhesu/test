...
<html>
<head>
	<title>ERP Demo - Creating New Product</title>
</head>
<body>
<h2><spring:message code="module.product.create.title"/></h2>
<form:form method="post" action="save.html" commandName="product">
	<table>
	<tr>
	...
	<tr>
		<td colspan="2">
			<input type="submit" value="<spring:message code="module.product.button.add"/>"/>
		</td>
	</tr>
	</table>
</form:form>
